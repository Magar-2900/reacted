...
class Wscontroller extends REST_Controller 
{
	...
	public function stripe_webhook_post(){
		...
		case 'payment_intent.succeeded':
			...
			$res = $this->CartModel->update_order_status($order_id,$order1);
			echo $sql = 'DELETE cart, cart_items FROM cart INNER JOIN cart_items WHERE cart.iCartId = cart_items.iCartId and cart.iCartId = '.$cartId.' and cart.iUsersId = '.$userId;
			$this->db->query($sql);
